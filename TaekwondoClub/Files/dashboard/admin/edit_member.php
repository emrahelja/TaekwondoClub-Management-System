           ...
           <td height="35"><table width="100%" border="0" align="center">
             ...
             <tr>
               ...
               <td height="35"><select id="boxxe" name="gender" id="gender" required>
						...
						<option <?php if($gender == 'Male'){echo("selected");}?> value="Male">MUSKO</option>
						<option <?php if($gender == 'Female'){echo("selected");}?> value="Female">ZENSKO</option>
						</select></td><br>
             </tr>
			  <tr>
