         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
             ...
             <tr>
               ...
               <td height="35"><input name="planname" id="planName" type="text" placeholder="Unesi grupu" size="40"></td>
             </tr>
             <tr>
               <td height="35">TERMIN</td>
               <td height="35"><input type="text" name="desc" id="planDesc" placeholder="Unesi termin" size="40"></td>
             </tr>
             ...
             <tr>
               <td height="35">&nbsp;</td>
               <td height="35"><input class="a1-btn a1-blue" type="submit" name="submit" id="submit" value="KREIRAJ" >
